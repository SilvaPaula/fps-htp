...
asr = asreml(fixed= mode ~ 1, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo1, maxit=100, subset= trt=='Untreated')
summary(asr)$varcomp
...
asr = asreml(fixed= mode ~ 1, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo2, maxit=100, subset= trt=='Untreated')
summary(asr)$varcomp
...
asr = asreml(fixed= mode ~ 1, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo3, maxit=100, subset= trt=='Untreated')
summary(asr)$varcomp
...
asr = asreml(fixed= mode ~ 1, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo4, maxit=100, subset= trt=='Untreated')
summary(asr)$varcomp
...
asr = asreml(fixed= mode ~ 1, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo5, maxit=100, subset= trt=='Untreated')
summary(asr)$varcomp
...
```{r}
## Date 2018-04-04
asr = asreml(fixed= mode ~ 1 + h_degree, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo1, maxit=100, subset= trt=='Untreated')
summary(asr)$varcomp
...
## Date 2018-04-12
asr = asreml(fixed= mode ~ 1 + h_degree, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo2, maxit=100, subset= trt=='Untreated')
summary(asr)$varcomp
...
## Date 2018-04-19
asr = asreml(fixed= mode ~ 1 + h_degree, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo3, maxit=100, subset= trt=='Untreated')
summary(asr)$varcomp
...
## Date 2018-04-23
asr = asreml(fixed= mode ~ 1 + h_degree, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo4, maxit=100, subset= trt=='Untreated')
summary(asr)$varcomp
...
## Date 2018-05-16
asr = asreml(fixed= mode ~ 1 + h_degree, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo5, maxit=100, subset= trt=='Untreated')
summary(asr)$varcomp
...
```{r}
## Date 2018-04-04
asr = asreml(fixed= mode ~ 1, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo1, maxit=100, subset= trt=='Treated')
summary(asr)$varcomp
...
## Date 2018-04-12
asr = asreml(fixed= mode ~ 1, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo2, maxit=100, subset= trt=='Treated')
summary(asr)$varcomp
...
## Date 2018-04-19
asr = asreml(fixed= mode ~ 1, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo3, maxit=60, subset= trt=='Treated')
summary(asr)$varcomp
...
## Date 2018-04-23
asr = asreml(fixed= mode ~ 1, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo4, maxit=100, subset= trt=='Treated')
summary(asr)$varcomp
...
## Date 2018-05-16
asr = asreml(fixed= mode ~ 1, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo5, maxit=100, subset= trt=='Treated')
summary(asr)$varcomp
...
```{r}
## Date 2018-04-04
asr = asreml(fixed= mode ~ 1 + h_degree, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo1, maxit=100, subset= trt=='Treated')
summary(asr)$varcomp
...
## Date 2018-04-12
asr = asreml(fixed= mode ~ 1 + h_degree, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo2, maxit=100, subset= trt=='Treated')
summary(asr)$varcomp
...
## Date 2018-04-19
asr = asreml(fixed= mode ~ 1 + h_degree, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo3, maxit=100, subset= trt=='Treated')
summary(asr)$varcomp
...
## Date 2018-04-23
asr = asreml(fixed= mode ~ 1 + h_degree, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo4, maxit=100, subset= trt=='Treated')
summary(asr)$varcomp
...
## Date 2018-05-16
asr = asreml(fixed= mode ~ 1 + h_degree, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo5, maxit=100, subset= trt=='Treated')
summary(asr)$varcomp
...
asr <- asreml(fixed = mode ~ 1 , random =  ~id(entry) + ~id(rep) + ~id(rep):(block) + ~id(rep):(row) + ~id(rep):(column), data=ortho8, maxit=100) 
summary(asr)$varcomp
...
asr <- asreml(fixed = mode ~ 1 , random =  ~id(entry) + ~id(rep) + ~id(rep):(block) + ~id(rep):(row) + ~id(rep):(column), data=ortho9, maxit=100) 
summary(asr)$varcomp
...
asr <- asreml(fixed= mode ~ 1 , random = ~id(entry) + ~id(rep) + ~id(rep):(block) + ~id(rep):(row) + ~id(rep):(column), data=plot.mean11, maxit=100)
summary(asr)$varcomp
...
asr <- asreml(fixed= mode ~ 1 , random = ~id(entry) + ~id(rep) + ~id(rep):(block) + ~id(rep):(row) + ~id(rep):(column), data=plot.mean12, maxit=100)
summary(asr)$varcomp
...
```{r}
## Date 2018-03-02
asr <- asreml(fixed = mode ~ 1, random =  ~id(entry) + ~id(rep) + ~id(rep):(block) + ~id(rep):(row) + ~id(rep):(column) + ~id(rep):(row):(column):(entry), data=photo11, maxit=100, pworkspace='500mb', workspace='5gb') 
summary(asr)$varcomp
...
## Date 2018-03-19
asr <- asreml(fixed = mode ~ 1, random =  ~id(entry) + ~id(rep) + ~id(rep):(block) + ~id(rep):(row) + ~id(rep):(column) + ~id(rep):(row):(column):(entry), data=photo12, maxit=100, pworkspace='500mb', workspace='5gb') 
summary(asr)$varcomp
...
asr = asreml(fixed= mode ~ 1, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo11, maxit=100)
summary(asr)$varcomp
...
asr = asreml(fixed= mode ~ 1, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo12, maxit=100)
summary(asr)$varcomp
...
```{r}
## Date 2018-03-02
asr = asreml(fixed= mode ~ 1 + h_degree, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo11, maxit=100)
summary(asr)$varcomp
...
## Date 2018-03-19
asr = asreml(fixed= mode ~ 1 + h_degree, random =  ~id(entry) + ~id(rep) + ~id(img), data=photo12, maxit=100)
summary(asr)$varcomp
